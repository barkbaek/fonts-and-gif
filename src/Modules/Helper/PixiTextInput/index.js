...
class TextInput extends PIXI.Container{
    ...
    setInputStyle(key,value){
        ...
        console.log(`PIXI.TextInput - key: ${key}, value: ${value}`)
        if(this._substituted && (key==='fontFamily' || key==='fontSize' /*|| key === 'stroke' || key === 'strokeThickness'*/))
    ...
    _updateFontMetrics(){
        ...
        console.log('_updateFontMetrics - style : ')
        console.dir(style)
